...
secret="yvBzqfORpR5RJLCgHLaCaodstiCwGVGHoeiOzVu7xSHcffjWxl"
...
# get some tweets
tweets = searchTwitter('@MonashUni', 1500, lang="en")
# get text 
...
{
  tmp = getSentiment(tweet_clean[i], "e6b10b8bc49a66eb3a08529e25dfe211")
